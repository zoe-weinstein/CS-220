...
def verify_new_notebook(old_cells, new_cells, orig_notebook, is_autograder=False):
    ...
    for q in old_new_nb_match:
        ...
        if NO_RERUN in formats[q] and is_autograder:
            print("skipping rerun check for " + str(q))
            continue
...
def main():
    IS_AUTOGRADER = "autograder" in sys.argv
    ...
    verify_match_msg = verify_new_notebook(old_answer_cells, new_answer_cells, orig_notebook, is_autograder=IS_AUTOGRADER)
